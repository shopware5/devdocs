...
This article will focus CSRF attack protection , a new security features included in Shopware. First, a short introduction to the problem:
...
4. The attacker can now created a page that submits this form onload. He has posted the link to that page on a forum.
