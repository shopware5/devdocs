...
messages are considerably smaller then standard HTTP Requests and Responses. Additionally it improves the usabillity
...
**Project**: Creating a testing plattform for our shopware academy
...
As this project was more for "learning purposes" to teach myself how to get a Ssymfony project started, it will probably
...
**Project**: Central asset managment
...
**Project**: Continuous integration visualisation   

Continuous integration is a key factor for high quality software. It ensures a continuous quality throughout the software.
On the other hand developers have to be aware of the current status of the project in a non-disturbing way matter.
...
In my hackathon project I solved above issues by making shopware installable as a composer dependency itself. That means
...
data schema would have for the backend. I started with contacts and calenders as those are widely implemented
