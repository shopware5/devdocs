...
will allow you to invalidate / clear your remote cache from within Shopware. **If you using Nginx without Varnish, you have to add here the URL to Shopware with the a custom URL Path, cause Nginx does not allow BAN Requests on "/". Example: http://example.com/ban**
