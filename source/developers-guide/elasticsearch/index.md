...
The `getActiveValues` function validates which value should be used for activeMin and activeMax parameter, by checking if the criteria class contains the `SalesCondition`.
